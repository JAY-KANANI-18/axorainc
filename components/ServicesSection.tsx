...
const services = [
  ...
  },
  {
    ...
    icon: <FaRocket className="text-2xl text-blue-900" />,
  },
  {
    ...
    icon: <FaBrain className="text-2xl text-blue-900" />,
  },
  {
    ...
    icon: <FaBuilding className="text-2xl text-blue-900" />,
  },
  {
  ...
  },
  {
    ...
    icon: <FaCogs className="text-2xl text-blue-900" />,
  },
  {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-slate-600">
            Partner with a multidisciplinary team covering strategy, design,
            engineering, go-to-market, and ongoing optimization. Every
            engagement is anchored in measurable outcomes and AI-led innovation.
          </p>
        </div>
            ...
            >
              ...
              <div className="relative z-10 space-y-5">
                ...
                <div className="mt-6">
                  <Link
                    href={
                      slugMap[service.anchor]
                        ? `/services/${slugMap[service.anchor]}`
                        : "/services"
                    }
                    className="inline-flex items-center gap-2 text-blue-900 font-semibold hover:text-blue-800 transition-colors"
                  >
                    Learn more
                    <svg
                      className="w-4 h-4"
